    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[50vh] bg-gray-900 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center text-white">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-serif uppercase tracking-[0.2em] mb-6">Our Collections</h1>
            <p className="text-sm md:text-base text-white/80 tracking-widest uppercase leading-relaxed max-w-2xl mx-auto">
                    ...
                    <div className="relative h-80 rounded-2xl overflow-hidden bg-gray-200 shadow-lg group-hover:shadow-2xl transition-all duration-300">
                      ...
                      <div className="absolute inset-0 flex items-end p-6">
                        <div className="text-white">
                          <h3 className="text-lg md:text-xl font-serif uppercase tracking-widest mb-2 group-hover:text-gray-300 transition-colors">
                            {collection.name}
                          </h3>
                          <p className="text-[10px] uppercase tracking-widest text-white/80 line-clamp-3 mb-4">
                      ...
                      {/* Featured Badge */}
                      {collection.featured && (
                        <div className="absolute top-4 left-4 bg-white text-gray-900 text-[10px] uppercase tracking-widest font-medium px-3 py-1 rounded-none border border-gray-900">
                          Featured
                        </div>
                      )}
      ...
      {/* Call to Action */}
      <section className="py-24 border-t border-gray-100 mt-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-serif uppercase tracking-widest text-gray-900 mb-6">
              Can't Find What You're Looking For?
            </h2>
            <p className="text-sm text-gray-500 uppercase tracking-widest mb-10 leading-relaxed max-w-2xl mx-auto">
              Our design consultants can help you create a custom collection tailored to your unique style and needs
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/services"
                className="inline-flex items-center px-10 py-4 bg-gray-900 text-white text-xs uppercase tracking-widest font-medium rounded-none hover:bg-gray-800 transition-colors"
              >
                Book Consultation
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center px-10 py-4 border border-gray-900 text-gray-900 text-xs uppercase tracking-widest font-medium rounded-none hover:bg-gray-50 transition-colors"
              >
                Get in Touch
              </Link>
            </div>
